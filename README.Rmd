...
In this section we describe how to use the smORF gtf to find mutations in their CDS region from GWAS catalog. You can download GWAS catalog from XXXX . The goal is to find if there are any overlpa, and in the case of an overlap, if it results to a misense or non-sense mutation.
